                ...
                if($x==0){
                    ...
                    $registros=mysqli_query($conexion,"select 
                        ...
                        if($cliqueado==1){
                            ...
                            echo "<td>
                                <button name=\"boton\" value=\"$z\" class=\"action-button shadow animate red\"><strong>$propietario</Strong><br>$mascota</button>
                            </td>";

                        }else{
                            echo "<td>
                               <button disabled name=\"boton\" value=\"$z\"  class=\"action-button shadow animate green\"><strong>!HORA LIBRE!</Strong><br></button></a>
                            </td>";
                        }
